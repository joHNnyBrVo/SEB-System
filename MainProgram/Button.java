...
import CustomComponent.ShadowRenderer;
...
public class Button extends JButton {
    ...
    private BufferedImage createShadow() {
        ...
        if (width > 0 && height > 0) {
            ...
            RoundRectangle2D shadowShape = new RoundRectangle2D.Double(0, 0, width, height, round, round);
            g2.setColor(new Color(0, 0, 0, 0)); // Transparent background
            g2.fill(shadowShape);
            g2.dispose();

            ShadowRenderer shadowRenderer = new ShadowRenderer(shadowSize.top, 0.5f, shadowColor);
            return shadowRenderer.createShadow(shadowImage);
        }
        return null;
    }
}
